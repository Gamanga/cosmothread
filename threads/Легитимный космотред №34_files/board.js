...
Stage('Плашка',                      'abuplashque',    Stage.DOMREADY,     function(){
    ...
    if(!mob) {
    	content = 'Все главные новости — подписывайся на <a href="https://t.me/ru2ch_news">Ньюсач</a> в телеграме <br> Значительно снижены цены на <a href="https://2ch.hk/static/market.html">пасскоды</a> - от 50 рублей.';
    } else {
        //АРХИВ И ГЛАВНАЯ
        let link = '';
        let banner = ''
